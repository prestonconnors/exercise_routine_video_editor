...
def main():
    ...
    parser.add_argument('--center_focus', type=float, help="Focus analysis on the center of the video. Value from 0.1 to 1.0 (e.g., 0.5 for the center 50%%). Analysis only.")
